...
class Automater_GUI:
    ...
    def create(self):
        ...
        #fill these with the index in self.portinfo of each respective device 
        self.cb_sensor_com.set_index(0) #sensor/demo board
        self.cb_fc_com.set_index(1) #syringe pump
        self.cb_scale_com.set_index(2) #scale

        self.connect_pump()
        self.connect_sensor()
        self.connect_scale()
        
        #sets a log name automatically
    ...
    def prep_test(self):
        self.test_list[self.test_index].reset()
        self.update_queue()
